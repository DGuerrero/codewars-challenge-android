...
import com.quoders.app.codewarschallenge.domain.users.GetUserInteractor
...
class SearchPresenter(val view: SearchContract.View, val usersRepository: UserRepository)
